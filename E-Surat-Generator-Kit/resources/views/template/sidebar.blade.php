 ...
 @if (auth()->user()->role == 'pengadaan')
     <nav id="sidebar" class="sidebar js-sidebar">
         <div class="sidebar-content js-simplebar">
             ...
             <a class="sidebar-brand" href="{{ route('dashboard.pengadaan') }}">
                <span class="align-middle">E-Surat-Generator-kit (Pengadaan)</span>
            </a>
 ...
 @if (auth()->user()->role == 'manager')
     <nav id="sidebar" class="sidebar js-sidebar">
         <div class="sidebar-content js-simplebar">
            <a class="sidebar-brand" href="{{ route('dashboard.manager') }}">
                <span class="align-middle">E-Surat-Generator-kit (Manager)</span>
            </a>
 ...
 @if (auth()->user()->role == 'vendor')
     <nav id="sidebar" class="sidebar js-sidebar">
         <div class="sidebar-content js-simplebar">
            <a class="sidebar-brand" href="{{ route('dashboard.vendor') }}">
                <span class="align-middle">E-Surat-Generator-kit (Vendor)</span>
            </a>
