                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col mt-0">
                                            <h5 class="card-title">Daftar Pegawai Terdaftar</h5>
                                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col mt-0">
                                            <h5 class="card-title">Daftar Vendor terdaftar</h5>
                                        </div>
            ...
            {{-- <div class="col-xl-6 col-xxl-7">
                <div class="card flex-fill w-100">
                    <div class="card-header">
                        ...
                        <h5 class="card-title mb-0">Kontrak Kerja</h5>
                    </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            new Chart(document.getElementById("chartjs-dashboard-line"), {
                ...
                data: {
                    ...
                    datasets: [{
                        label: "Jumlah Kontrak Kerja tahun 2023",
                        fill: true,
