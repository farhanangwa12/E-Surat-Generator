                            ...
                            <div class="row align-item-start justify-content-end mb-3">
                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="form-select" aria-label="Kode Masalah " name="kode_masalah"
                                        ...
                                        <option value="DAN.01.01"
                                            {{ $kontrakkerja->kode_masalah == 'DAN.01.01' ? 'Selected' : '' }}>Pengadaan
                                            Barang</option>
                                        <option value="DAN.01.02"
                                            {{ $kontrakkerja->kode_masalah == 'DAN.01.02' ? 'Selected' : '' }}>Pengadaan
                                            Jasa</option>
                                        <option value="DAN.01.03"
                                            {{ $kontrakkerja->kode_masalah == 'DAN.01.03' ? 'Selected' : '' }}>Pengadaan
                                            Barang & Jasa</option>
                                    </select>
                            ...
                            <div class="row align-item-start justify-content-end mb-3">
                                <div class="form-group col">
                                    ...
                                    <input type="text" name="lokasi_pekerjaan" class="form-control" id="lokasi_pekerjaan"
                                        value="{{ $kontrakkerja->lokasi_pekerjaan }}" placeholder="Masukkan nama lokasi">
                                </div>
                            ...
                            <div class="row align-item-start mb-3">
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="text" name="skk-ao" class="form-control" id="skk-ao"
                                        value="{{ $sumberanggaran->skk_ao }}" placeholder="Masukkan SKK-AO">
                                </div>
                            ...
                            <div class="row align-item-start mb-3">
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="date" name="tanggal_anggaran" class="form-control" id="tanggal_anggaran"
                                        value="{{ $sumberanggaran->tanggal_anggaran }}"
                                    ...
                                    <select class="form-select" aria-label="ven" name="ven" id="ven">
                                        ...
                                        @foreach ($vendor as $item)
                                            <option value="{{ $item->id_vendor }}"
                                                {{ $item->id_vendor == $kontrakkerja->id_vendor ? 'selected' : '' }}>
                                                {{ $item->penyedia }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row align-item-start mb-3">
                                <div class="form-group col">
                                    ...
                                    <input type="text" name="manager"
                                        value="{{ $penyelenggara->manager->nama_pengguna }}" class="form-control"
                                        id="manager" placeholder="Masukkan nama manager">
                                </div>
                                <div class="form-group col">
                                    <label for="pengawas_lapangan">Pengawas Lapangan</label>
                                    <input type="text" name="pengawas_lapangan" class="form-control"
                                        value=" {{ $penyelenggara->pengawas_lapangan->nama_pengguna }}"
                            ...
                            <div class="row align-item-start mb-3">
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="text" name="pengawas_k3" class="form-control" id="pengawas_k3"
                                        value="{{ $penyelenggara->pengawas_k3->nama_pengguna }}"
                            ...
                            <div class="row align-item-start mb-3">
                                <div class="form-group col">
                                    ...
                                    <input type="text" name="direksi" class="form-control" id="direksi"
                                        value="{{ $penyelenggara->direksi->nama_pengguna }}"
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="text" name="pengawas_pekerjaan" class="form-control"
                                        value="{{ $penyelenggara->pengawas_pekerjaan->nama_pengguna }}}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col"> <input type="date" name="tanggal_rks" class="form-control"
                                            id="tanggal_rks" placeholder="Masukkan nama rks"
                                            value="{{ $pembuatansurat->nomor_rks->tanggal_surat }}"></div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col"> <input type="date" name="tanggal_hps" class="form-control"
                                            value="{{ $pembuatansurat->nomor_hps->tanggal_surat }}" id="tanggal_hps">
                                    </div>
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col"> <input type="date" name="tanggal_pakta_pejabat"
                                            value="{{ $pembuatansurat->nomor_pakta_pejabat->tanggal_surat }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col"> <input type="date" name="tanggal_pakta_pengguna"
                                            value="{{ $pembuatansurat->nomor_pakta_pengguna->tanggal_surat }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col"> <input type="date" name="tanggal_undangan"
                                            value="{{ $pembuatansurat->nomor_undangan->tanggal_surat }}"
                            ...
                            <div class="form-group my-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col"> <input type="date" name="batas_akhir_dokumen_penawaran"
                                            class="form-control" id="batas_akhir_dokumen_penawaran" value="{{ $pembuatansurat->batas_akhir_dokumen_penawaran->tanggal_surat }}"></div>
                                </div>
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col"> <input type="date" name="tanggal_ba_negosiasi"
                                            value="{{ $pembuatansurat->nomor_ba_negosiasi->tanggal_surat }}"
...
@section('javascript')
    ...
    <script>
        ...
        document.getElementById('nomor_hps').value = NoUrut.value + ".HPS/" + kodeMasalah.value + "/UPKTIMOR/" + tahun
            .value;
        document.getElementById('nomor_pakta_pejabat').value = NoUrut.value + ".PI//" + kodeMasalah.value + "/UPKTIMOR/" +
            tahun.value;
        document.getElementById('nomor_undangan').value = NoUrut.value + ".UND/" + kodeMasalah.value + "/200900/" + tahun
            .value;
        document.getElementById('nomor_pakta_pengguna').value = NoUrut.value + ".PI/" + kodeMasalah.value + "/M-UPKTIMOR/" +
            tahun.value;
        document.getElementById('nomor_ba_buka').value = NoUrut.value + ".BA_PEMB/" + kodeMasalah.value + "/200900/" + tahun
            .value;
        document.getElementById('nomor_ba_evaluasi').value = NoUrut.value + ".BA-EVA/" + kodeMasalah.value + "/200900/" +
            tahun.value;
        document.getElementById('nomor_ba_negosiasi').value = NoUrut.value + ".BA-NEG/" + kodeMasalah.value + "/200900/" +
            tahun.value;
        document.getElementById('nomor_ba_hasil_pl').value = NoUrut.value + ".BA-HPL/" + kodeMasalah.value + "/200900/" +
            tahun.value;
