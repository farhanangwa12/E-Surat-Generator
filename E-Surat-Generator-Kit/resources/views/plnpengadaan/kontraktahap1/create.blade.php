                        ...
                        <h1>Upload File Excel</h3>
                            ...
                            <div>
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">- Data yang disimpan dari Excel Worksheet BOQ (Bill Of Quantity) yaitu hanya
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    <div class="col"><input type="text" name="nomor_ba_evaluasi"
                                            class="form-control" id="nomor_ba_evaluasi" placeholder="BA Evaluasi" readonly>
                                    </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    <div class="col"><input type="text" name="nomor_ba_negosiasi"
                                            class="form-control" id="nomor_ba_negosiasi" placeholder="BA Negosiasi"
                                            readonly>
                                    </div>
