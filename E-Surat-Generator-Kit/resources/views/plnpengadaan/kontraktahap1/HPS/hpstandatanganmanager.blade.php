            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        Sebagai seorang manajer, dengan menandatangani dokumen ini, Anda menyatakan persetujuan terhadap isi
                        dokumen dan mengkonfirmasi bahwa dokumen tersebut telah disetujui, sehingga kontrak dapat
                        dilaksanakan.
                        <style>
                            #signature-canvas {
                    ...
                    <div class="card-body">
                        ...
                        <div class="btn-group me-2" role="group" aria-label="Tombol gabungan">
                            <a href="{{ route('tandatangan.manager.detail', ['id' => $id]) }}" class="btn btn-info">Kembali</a>
...
@section('javascript')
    ...
    <script>
        ...
        function convertToBase64() {
            ...
            xhr.open('POST', "{{ route('simpantandatanganhps') }}");
            xhr.setRequestHeader('X-CSRF-TOKEN', '{{ csrf_token() }}');
            xhr.onload = function() {
                if (xhr.status === 200) {
                    window.location.href = "{{ route('tandatangan.manager.detail', ['id' => $id]) }}";
